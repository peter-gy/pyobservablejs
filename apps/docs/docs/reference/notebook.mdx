...
An ordered collection of canonical cell handles. String indexing selects public
keys and integer indexing selects notebook positions. Iteration follows notebook
order, including anonymous cells.
...
[data namespace reference](data-access.mdx).
