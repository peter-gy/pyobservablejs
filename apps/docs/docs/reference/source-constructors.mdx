...
`Notebook.from_html` loads Notebook Kit HTML text. The `from_observablehq*`
constructors convert ObservableHQ document records to Notebook Kit HTML and
select the classic Observable standard library.
