...
`Notebook.from_html_file` constructor supplies the HTML file's parent
directory. See [Source constructors](source-constructors.mdx) for the
source constructor contracts and relative JavaScript import rewriting.
