---
title: Compose views
description: Place independent views from one shared notebook controller.
---
...
The example uses [marimo](https://docs.marimo.io/), a reactive Python notebook
editor, to place two views side by side.
...
See [Share inputs across Python and Observable](../connect/shared-inputs.mdx)
for input value shapes and [Display a notebook](notebooks.mdx#close-views) for
closing views.
