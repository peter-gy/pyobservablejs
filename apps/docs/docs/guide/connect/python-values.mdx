---
title: Send Python values
description: Publish Python values and update the reactive browser graph.
---
...
values and [Read browser results](browser-results.mdx) for the return
path.
