...
Observable-derived notebooks record their standard-library profile, source
identity, and declared dependency resolutions in the exported document.
A round trip through `from_html` preserves those choices and each cell language.
