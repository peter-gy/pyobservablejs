---
title: Core concepts
description: Notebook controllers, cell identity, renderable views, and state snapshots.
---
...
Continue with [Display views](render/display-views.mdx), [Select
cells](render/select-cells.mdx), and [Connect state](connect/python-to-observable.mdx).
