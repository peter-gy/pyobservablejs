...
- The npm `anywidget-bundle` package owns the app-agnostic Vite plugin, browser
...
`workspace:*` for internal dependencies and the pnpm catalog for shared
external versions. Pin matching npm and PyPI `anywidget-bundle` releases.
