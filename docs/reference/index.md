...
| ---------------------------------------------------------- | ----------------- | ---------------------------------------------------------------------------------- |
| [`Notebook`](notebook.md)                                  | Class             | Owns the Notebook Kit definition, attachments, variables, and shared input values. |
...
| [`NotebookCell`](notebook.md#notebookcell)                 | Class             | Selects one notebook cell and creates a view through `view()`.                     |
| [`CellValues`](values-and-graph.md#cellvalues)             | Frozen data class | Carries the synchronized values for one selected cell.                             |
...
| [`NotRenderedError`](values-and-graph.md#notrenderederror) | Exception         | Reports that the browser snapshot required for readback has not synchronized.      |
