...
| ---------------------------------------------------------- | ----------------- | ------------------------------------------------------------------------------------------ |
| [`Notebook`](notebook.md)                                  | Class             | Owns Notebook Kit source, widget state, file attachments, variables, and browser readback. |
...
| [`NotebookCell`](values-and-graph.md#notebookcell)         | Class             | Provides a displayable projection handle with cell-level values and graph metadata.        |
